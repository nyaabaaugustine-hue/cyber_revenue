...
async function seed() {
  ...
  const bizData: (typeof s.businesses.$inferInsert)[] = [
    ...
    {
      id: '7', businessId: 'KSI-0007-BKL', name: 'Golden Bookshop & Stationery',
      categoryId: 'cat-7', categoryName: 'Others', ownerName: 'Nana Yaa Asantewaa', ownerPhone: '+233 24 333 1122',
      lat: '6.6860', lng: '-1.5290', locationDescription: 'Kejetia, Ground Floor, Shop 78',
      districtId: dist.id, zoneId: 'zone-1', zoneName: 'Zone A - Central',
      photos: ['https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '900',
      lastCollectionAmount: '100', registeredBy: 'user-1', registeredByName: 'Emmanuel Owusu',
      registeredAt: new Date('2024-03-10T09:00:00Z'), lastVisitedAt: new Date('2024-06-09T11:00:00Z'),
    },
    {
      id: '8', businessId: 'KSI-0008-PLM', name: 'Mama\'s Palace Mini-Mart',
      categoryId: 'cat-1', categoryName: 'Trading', ownerName: 'Gifty Mensah', ownerPhone: '+233 20 444 5566',
      lat: '6.6895', lng: '-1.5265', locationDescription: 'Opera Square, Ground Floor',
      districtId: dist.id, zoneId: 'zone-1', zoneName: 'Zone A - Central',
      photos: ['https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'due', totalOutstanding: '250', totalCollected: '600',
      lastCollectionAmount: '100', registeredBy: 'user-1', registeredByName: 'Emmanuel Owusu',
      registeredAt: new Date('2024-04-05T08:00:00Z'), lastVisitedAt: new Date('2024-06-07T14:00:00Z'),
    },
    // Zone B - Adum (5 businesses)
    {
    ...
    {
      id: '9', businessId: 'KSI-0009-SPA', name: 'Golden Hands Hair Salon',
      categoryId: 'cat-6', categoryName: 'Services', ownerName: 'Akosua Mensah', ownerPhone: '+233 24 555 7788',
      lat: '6.6905', lng: '-1.5215', locationDescription: 'Adum Station, 2nd Floor',
      districtId: dist.id, zoneId: 'zone-2', zoneName: 'Zone B - Adum',
      photos: ['https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1200',
      lastCollectionAmount: '100', registeredBy: 'user-2', registeredByName: 'Akua Mensah',
      registeredAt: new Date('2024-03-15T10:00:00Z'), lastVisitedAt: new Date('2024-06-10T09:30:00Z'),
    },
    {
      id: '10', businessId: 'KSI-0010-PPH', name: 'Prosperity Phone Hub',
      categoryId: 'cat-3', categoryName: 'Electronics', ownerName: 'Samuel Osei', ownerPhone: '+233 27 666 8899',
      lat: '6.6915', lng: '-1.5205', locationDescription: 'Adum, Near VIP Station',
      districtId: dist.id, zoneId: 'zone-2', zoneName: 'Zone B - Adum',
      photos: ['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'overdue', totalOutstanding: '350', totalCollected: '2100',
      lastCollectionAmount: '150', registeredBy: 'user-2', registeredByName: 'Akua Mensah',
      registeredAt: new Date('2024-02-28T11:00:00Z'), lastVisitedAt: new Date('2024-06-05T15:00:00Z'),
    },
    {
      id: '11', businessId: 'KSI-0011-FDR', name: 'Fresh Day Restaurant',
      categoryId: 'cat-2', categoryName: 'Food & Beverage', ownerName: 'Kwaku Frimpong', ownerPhone: '+233 20 777 0011',
      lat: '6.6920', lng: '-1.5190', locationDescription: 'Adum Roundabout, Ground Floor',
      districtId: dist.id, zoneId: 'zone-2', zoneName: 'Zone B - Adum',
      photos: ['https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1800',
      lastCollectionAmount: '200', registeredBy: 'user-6', registeredByName: 'Kofi Appiah',
      registeredAt: new Date('2024-01-25T09:00:00Z'), lastVisitedAt: new Date('2024-06-13T10:00:00Z'),
    },
    // Zone C - Bantama (4 businesses)
    {
    ...
    {
      id: '12', businessId: 'KSI-0012-SPL', name: 'Sunshine Supermarket',
      categoryId: 'cat-1', categoryName: 'Trading', ownerName: 'Abena Pokua', ownerPhone: '+233 24 888 2233',
      lat: '6.6945', lng: '-1.5360', locationDescription: 'Bantama Market, 1st Floor',
      districtId: dist.id, zoneId: 'zone-3', zoneName: 'Zone C - Bantama',
      photos: ['https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '2800',
      lastCollectionAmount: '250', registeredBy: 'user-3', registeredByName: 'Kofi Asante',
      registeredAt: new Date('2024-02-05T08:30:00Z'), lastVisitedAt: new Date('2024-06-12T11:30:00Z'),
    },
    {
      id: '13', businessId: 'KSI-0013-EPT', name: 'Excel Point Technology',
      categoryId: 'cat-3', categoryName: 'Electronics', ownerName: 'Richard Ansah', ownerPhone: '+233 20 999 4455',
      lat: '6.6955', lng: '-1.5345', locationDescription: 'Bantama, Near the Traffic Light',
      districtId: dist.id, zoneId: 'zone-3', zoneName: 'Zone C - Bantama',
      photos: ['https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'due', totalOutstanding: '200', totalCollected: '1600',
      lastCollectionAmount: '150', registeredBy: 'user-3', registeredByName: 'Kofi Asante',
      registeredAt: new Date('2024-03-20T14:00:00Z'), lastVisitedAt: new Date('2024-06-06T13:00:00Z'),
    },
    {
      id: '14', businessId: 'KSI-0014-BTW', name: 'Grace Beauty World',
      categoryId: 'cat-5', categoryName: 'Fashion & Textiles', ownerName: 'Grace Addai', ownerPhone: '+233 55 111 6677',
      lat: '6.6940', lng: '-1.5355', locationDescription: 'Bantama, Opposite the Hospital',
      districtId: dist.id, zoneId: 'zone-3', zoneName: 'Zone C - Bantama',
      photos: ['https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1100',
      lastCollectionAmount: '100', registeredBy: 'user-3', registeredByName: 'Kofi Asante',
      registeredAt: new Date('2024-04-10T10:00:00Z'), lastVisitedAt: new Date('2024-06-11T09:00:00Z'),
    },
    // Zone D - Suame (4 businesses)
    {
    ...
    {
      id: '15', businessId: 'KSI-0015-AFL', name: 'Afia Luxury Salon',
      categoryId: 'cat-6', categoryName: 'Services', ownerName: 'Afia Serwaa', ownerPhone: '+233 24 222 8800',
      lat: '6.6990', lng: '-1.5110', locationDescription: 'Suame Magazine, Near the Mechanic Area',
      districtId: dist.id, zoneId: 'zone-4', zoneName: 'Zone D - Suame',
      photos: ['https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1400',
      lastCollectionAmount: '100', registeredBy: 'user-4', registeredByName: 'Ama Boateng',
      registeredAt: new Date('2024-03-25T11:00:00Z'), lastVisitedAt: new Date('2024-06-10T14:00:00Z'),
    },
    {
      id: '16', businessId: 'KSI-0016-WMS', name: 'Wofa Men\'s Store',
      categoryId: 'cat-1', categoryName: 'Trading', ownerName: 'Kwadwo Mensah', ownerPhone: '+233 20 333 9900',
      lat: '6.7010', lng: '-1.5095', locationDescription: 'Suame, Near the Lorry Park',
      districtId: dist.id, zoneId: 'zone-4', zoneName: 'Zone D - Suame',
      photos: ['https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'overdue', totalOutstanding: '300', totalCollected: '950',
      lastCollectionAmount: '100', registeredBy: 'user-4', registeredByName: 'Ama Boateng',
      registeredAt: new Date('2024-04-15T09:00:00Z'), lastVisitedAt: new Date('2024-06-04T10:00:00Z'),
    },
    {
      id: '17', businessId: 'KSI-0017-EFS', name: 'Emefa Food Stall',
      categoryId: 'cat-2', categoryName: 'Food & Beverage', ownerName: 'Emefa Dufie', ownerPhone: '+233 27 444 1122',
      lat: '6.6995', lng: '-1.5105', locationDescription: 'Suame, Near the Market',
      districtId: dist.id, zoneId: 'zone-4', zoneName: 'Zone D - Suame',
      photos: ['https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1350',
      lastCollectionAmount: '150', registeredBy: 'user-5', registeredByName: 'Yaw Darko',
      registeredAt: new Date('2024-02-15T10:00:00Z'), lastVisitedAt: new Date('2024-06-12T12:00:00Z'),
    },
    // Zone E - Tafo (3 businesses)
    {
      id: '18', businessId: 'KSI-0018-TGS', name: 'True Grace Stationery',
      categoryId: 'cat-7', categoryName: 'Others', ownerName: 'Patricia Owusu', ownerPhone: '+233 24 555 3344',
      lat: '6.7050', lng: '-1.5050', locationDescription: 'Tafo Station, Near the Barrier',
      districtId: dist.id, zoneId: 'zone-5', zoneName: 'Zone E - Tafo',
      photos: ['https://images.unsplash.com/photo-1456735190827-d1262f71b8a3?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '700',
      lastCollectionAmount: '80', registeredBy: 'user-5', registeredByName: 'Yaw Darko',
      registeredAt: new Date('2024-04-20T10:00:00Z'), lastVisitedAt: new Date('2024-06-08T09:00:00Z'),
    },
    {
      id: '19', businessId: 'KSI-0019-GHL', name: 'God\'s Help Logistics',
      categoryId: 'cat-6', categoryName: 'Services', ownerName: 'Isaac Kumi', ownerPhone: '+233 20 666 5577',
      lat: '6.7045', lng: '-1.5060', locationDescription: 'Tafo, Near the Lorry Park',
      districtId: dist.id, zoneId: 'zone-5', zoneName: 'Zone E - Tafo',
      photos: ['https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'paid', totalOutstanding: '0', totalCollected: '1800',
      lastCollectionAmount: '200', registeredBy: 'user-5', registeredByName: 'Yaw Darko',
      registeredAt: new Date('2024-01-20T08:00:00Z'), lastVisitedAt: new Date('2024-06-11T11:00:00Z'),
    },
    {
      id: '20', businessId: 'KSI-0020-NPM', name: 'New Pearl Mini Market',
      categoryId: 'cat-1', categoryName: 'Trading', ownerName: 'Esther Boateng', ownerPhone: '+233 55 888 2211',
      lat: '6.7060', lng: '-1.5040', locationDescription: 'Tafo, Near the School',
      districtId: dist.id, zoneId: 'zone-5', zoneName: 'Zone E - Tafo',
      photos: ['https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=800&h=600&fit=crop'],
      status: 'active', levyStatus: 'due', totalOutstanding: '180', totalCollected: '550',
      lastCollectionAmount: '80', registeredBy: 'user-5', registeredByName: 'Yaw Darko',
      registeredAt: new Date('2024-05-01T09:00:00Z'), lastVisitedAt: new Date('2024-06-09T10:30:00Z'),
    },
  ];
  ...
  const visitData: (typeof s.visits.$inferInsert)[] = [
    { id: 'visit-1', businessId: '1', officerId: 'user-1', officerName: 'Emmanuel Owusu', date: new Date('2024-06-14T10:30:00Z'), status: 'completed', collectionAmount: '150', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-2', businessId: '2', officerId: 'user-2', officerName: 'Akua Mensah', date: new Date('2024-06-14T10:15:00Z'), status: 'completed', collectionAmount: '200', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-3', businessId: '3', officerId: 'user-1', officerName: 'Emmanuel Owusu', date: new Date('2024-06-14T09:00:00Z'), status: 'completed', collectionAmount: '500', paymentMethod: 'cash', gpsVerified: false },
    { id: 'visit-4', businessId: '4', officerId: 'user-3', officerName: 'Kofi Asante', date: new Date('2024-06-14T09:45:00Z'), status: 'completed', collectionAmount: '350', paymentMethod: 'pos', gpsVerified: true },
    { id: 'visit-5', businessId: '5', officerId: 'user-6', officerName: 'Kofi Appiah', date: new Date('2024-06-14T10:00:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-6', businessId: '6', officerId: 'user-5', officerName: 'Yaw Darko', date: new Date('2024-06-14T09:30:00Z'), status: 'completed', collectionAmount: '120', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-7', businessId: '7', officerId: 'user-1', officerName: 'Emmanuel Owusu', date: new Date('2024-06-14T11:00:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-8', businessId: '8', officerId: 'user-1', officerName: 'Emmanuel Owusu', date: new Date('2024-06-14T11:30:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-9', businessId: '9', officerId: 'user-6', officerName: 'Kofi Appiah', date: new Date('2024-06-14T10:30:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-10', businessId: '10', officerId: 'user-6', officerName: 'Kofi Appiah', date: new Date('2024-06-14T11:00:00Z'), status: 'completed', collectionAmount: '150', paymentMethod: 'pos', gpsVerified: true },
    { id: 'visit-11', businessId: '11', officerId: 'user-6', officerName: 'Kofi Appiah', date: new Date('2024-06-14T11:30:00Z'), status: 'completed', collectionAmount: '200', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-12', businessId: '12', officerId: 'user-3', officerName: 'Kofi Asante', date: new Date('2024-06-14T10:15:00Z'), status: 'completed', collectionAmount: '250', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-13', businessId: '13', officerId: 'user-3', officerName: 'Kofi Asante', date: new Date('2024-06-14T10:45:00Z'), status: 'completed', collectionAmount: '150', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-14', businessId: '14', officerId: 'user-3', officerName: 'Kofi Asante', date: new Date('2024-06-14T11:15:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-15', businessId: '15', officerId: 'user-4', officerName: 'Ama Boateng', date: new Date('2024-06-14T10:00:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-16', businessId: '16', officerId: 'user-4', officerName: 'Ama Boateng', date: new Date('2024-06-14T10:30:00Z'), status: 'completed', collectionAmount: '100', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-17', businessId: '17', officerId: 'user-5', officerName: 'Yaw Darko', date: new Date('2024-06-14T10:00:00Z'), status: 'completed', collectionAmount: '150', paymentMethod: 'mobile_money', gpsVerified: true },
    { id: 'visit-18', businessId: '18', officerId: 'user-5', officerName: 'Yaw Darko', date: new Date('2024-06-14T10:30:00Z'), status: 'completed', collectionAmount: '80', paymentMethod: 'cash', gpsVerified: true },
    { id: 'visit-19', businessId: '19', officerId: 'user-5', officerName: 'Yaw Darko', date: new Date('2024-06-14T11:00:00Z'), status: 'completed', collectionAmount: '200', paymentMethod: 'pos', gpsVerified: true },
    { id: 'visit-20', businessId: '20', officerId: 'user-5', officerName: 'Yaw Darko', date: new Date('2024-06-14T11:30:00Z'), status: 'completed', collectionAmount: '80', paymentMethod: 'mobile_money', gpsVerified: true },
  ];
  ...
  const colData: (typeof s.collections.$inferInsert)[] = [
    { id: 'col-1', receiptNumber: 'KSI-2024-00012345', businessId: '1', businessName: 'Makola Trading Ventures', visitId: 'visit-1', officerId: 'user-1', officerName: 'Emmanuel Owusu', amount: '150', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-284729', collectionDate: new Date('2024-06-14T10:30:00Z'), gpsVerified: true, collectionLat: '6.6885', collectionLng: '-1.5273' },
    { id: 'col-2', receiptNumber: 'KSI-2024-00012346', businessId: '2', businessName: 'Adwoa\'s Chop Bar', visitId: 'visit-2', officerId: 'user-2', officerName: 'Akua Mensah', amount: '200', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T10:15:00Z'), gpsVerified: true, collectionLat: '6.6900', collectionLng: '-1.5200' },
    { id: 'col-3', receiptNumber: 'KSI-2024-00012347', businessId: '3', businessName: 'Kwame\'s Electronics Shop', visitId: 'visit-3', officerId: 'user-1', officerName: 'Emmanuel Owusu', amount: '500', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T09:00:00Z'), gpsVerified: false, collectionLat: '6.6880', collectionLng: '-1.5240' },
    { id: 'col-4', receiptNumber: 'KSI-2024-00012348', businessId: '4', businessName: 'Peace Pharmacy', visitId: 'visit-4', officerId: 'user-3', officerName: 'Kofi Asante', amount: '350', paymentMethod: 'pos', collectionDate: new Date('2024-06-14T09:45:00Z'), gpsVerified: true, collectionLat: '6.6950', collectionLng: '-1.5350' },
    { id: 'col-5', receiptNumber: 'KSI-2024-00012349', businessId: '5', businessName: 'Ofori\'s Tailoring Shop', visitId: 'visit-5', officerId: 'user-6', officerName: 'Kofi Appiah', amount: '100', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-401285', collectionDate: new Date('2024-06-14T10:00:00Z'), gpsVerified: true, collectionLat: '6.6910', collectionLng: '-1.5220' },
    { id: 'col-6', receiptNumber: 'KSI-2024-00012350', businessId: '6', businessName: 'Nana\'s Car Wash', visitId: 'visit-6', officerId: 'user-5', officerName: 'Yaw Darko', amount: '120', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-395817', collectionDate: new Date('2024-06-14T09:30:00Z'), gpsVerified: true, collectionLat: '6.7000', collectionLng: '-1.5100' },
    { id: 'col-7', receiptNumber: 'KSI-2024-00012351', businessId: '7', businessName: 'Golden Bookshop & Stationery', visitId: 'visit-7', officerId: 'user-1', officerName: 'Emmanuel Owusu', amount: '100', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T11:00:00Z'), gpsVerified: true, collectionLat: '6.6860', collectionLng: '-1.5290' },
    { id: 'col-8', receiptNumber: 'KSI-2024-00012352', businessId: '8', businessName: 'Mama\'s Palace Mini-Mart', visitId: 'visit-8', officerId: 'user-1', officerName: 'Emmanuel Owusu', amount: '100', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-408821', collectionDate: new Date('2024-06-14T11:30:00Z'), gpsVerified: true, collectionLat: '6.6895', collectionLng: '-1.5265' },
    { id: 'col-9', receiptNumber: 'KSI-2024-00012353', businessId: '9', businessName: 'Golden Hands Hair Salon', visitId: 'visit-9', officerId: 'user-6', officerName: 'Kofi Appiah', amount: '100', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T10:30:00Z'), gpsVerified: true, collectionLat: '6.6905', collectionLng: '-1.5215' },
    { id: 'col-10', receiptNumber: 'KSI-2024-00012354', businessId: '10', businessName: 'Prosperity Phone Hub', visitId: 'visit-10', officerId: 'user-6', officerName: 'Kofi Appiah', amount: '150', paymentMethod: 'pos', collectionDate: new Date('2024-06-14T11:00:00Z'), gpsVerified: true, collectionLat: '6.6915', collectionLng: '-1.5205' },
    { id: 'col-11', receiptNumber: 'KSI-2024-00012355', businessId: '11', businessName: 'Fresh Day Restaurant', visitId: 'visit-11', officerId: 'user-6', officerName: 'Kofi Appiah', amount: '200', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-412190', collectionDate: new Date('2024-06-14T11:30:00Z'), gpsVerified: true, collectionLat: '6.6920', collectionLng: '-1.5190' },
    { id: 'col-12', receiptNumber: 'KSI-2024-00012356', businessId: '12', businessName: 'Sunshine Supermarket', visitId: 'visit-12', officerId: 'user-3', officerName: 'Kofi Asante', amount: '250', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T10:15:00Z'), gpsVerified: true, collectionLat: '6.6945', collectionLng: '-1.5360' },
    { id: 'col-13', receiptNumber: 'KSI-2024-00012357', businessId: '13', businessName: 'Excel Point Technology', visitId: 'visit-13', officerId: 'user-3', officerName: 'Kofi Asante', amount: '150', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-415503', collectionDate: new Date('2024-06-14T10:45:00Z'), gpsVerified: true, collectionLat: '6.6955', collectionLng: '-1.5345' },
    { id: 'col-14', receiptNumber: 'KSI-2024-00012358', businessId: '14', businessName: 'Grace Beauty World', visitId: 'visit-14', officerId: 'user-3', officerName: 'Kofi Asante', amount: '100', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T11:15:00Z'), gpsVerified: true, collectionLat: '6.6940', collectionLng: '-1.5355' },
    { id: 'col-15', receiptNumber: 'KSI-2024-00012359', businessId: '15', businessName: 'Afia Luxury Salon', visitId: 'visit-15', officerId: 'user-4', officerName: 'Ama Boateng', amount: '100', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-418876', collectionDate: new Date('2024-06-14T10:00:00Z'), gpsVerified: true, collectionLat: '6.6990', collectionLng: '-1.5110' },
    { id: 'col-16', receiptNumber: 'KSI-2024-00012360', businessId: '16', businessName: 'Wofa Men\'s Store', visitId: 'visit-16', officerId: 'user-4', officerName: 'Ama Boateng', amount: '100', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T10:30:00Z'), gpsVerified: true, collectionLat: '6.7010', collectionLng: '-1.5095' },
    { id: 'col-17', receiptNumber: 'KSI-2024-00012361', businessId: '17', businessName: 'Emefa Food Stall', visitId: 'visit-17', officerId: 'user-5', officerName: 'Yaw Darko', amount: '150', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-421199', collectionDate: new Date('2024-06-14T10:00:00Z'), gpsVerified: true, collectionLat: '6.6995', collectionLng: '-1.5105' },
    { id: 'col-18', receiptNumber: 'KSI-2024-00012362', businessId: '18', businessName: 'True Grace Stationery', visitId: 'visit-18', officerId: 'user-5', officerName: 'Yaw Darko', amount: '80', paymentMethod: 'cash', collectionDate: new Date('2024-06-14T10:30:00Z'), gpsVerified: true, collectionLat: '6.7050', collectionLng: '-1.5050' },
    { id: 'col-19', receiptNumber: 'KSI-2024-00012363', businessId: '19', businessName: 'God\'s Help Logistics', visitId: 'visit-19', officerId: 'user-5', officerName: 'Yaw Darko', amount: '200', paymentMethod: 'pos', collectionDate: new Date('2024-06-14T11:00:00Z'), gpsVerified: true, collectionLat: '6.7045', collectionLng: '-1.5060' },
    { id: 'col-20', receiptNumber: 'KSI-2024-00012364', businessId: '20', businessName: 'New Pearl Mini Market', visitId: 'visit-20', officerId: 'user-5', officerName: 'Yaw Darko', amount: '80', paymentMethod: 'mobile_money', mobileMoneyRef: 'MOM-424512', collectionDate: new Date('2024-06-14T11:30:00Z'), gpsVerified: true, collectionLat: '6.7060', collectionLng: '-1.5040' },
  ];
  ...
  const invData: (typeof s.invoices.$inferInsert)[] = [
    { id: 'inv-1', invoiceNumber: 'INV-2024-0001', businessId: '1', businessName: 'Makola Trading Ventures', amount: '2500', amountPaid: '1850', balanceDue: '650', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'partial', items: [{ description: 'Monthly Trading Levy', quantity: 1, unitPrice: 2500, amount: 2500 }] },
    { id: 'inv-2', invoiceNumber: 'INV-2024-0002', businessId: '2', businessName: 'Adwoa\'s Chop Bar', amount: '1800', amountPaid: '1800', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Food & Beverage Levy', quantity: 1, unitPrice: 1800, amount: 1800 }] },
    { id: 'inv-3', invoiceNumber: 'INV-2024-0003', businessId: '3', businessName: 'Kwame\'s Electronics Shop', amount: '4000', amountPaid: '3200', balanceDue: '800', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-15'), period: 'June 2024', status: 'overdue', items: [{ description: 'Monthly Electronics Levy', quantity: 1, unitPrice: 4000, amount: 4000 }] },
    { id: 'inv-4', invoiceNumber: 'INV-2024-0004', businessId: '4', businessName: 'Peace Pharmacy', amount: '3500', amountPaid: '3200', balanceDue: '300', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'partial', items: [{ description: 'Monthly Pharmaceutical Levy', quantity: 1, unitPrice: 3500, amount: 3500 }] },
    { id: 'inv-5', invoiceNumber: 'INV-2024-0005', businessId: '5', businessName: 'Ofori\'s Tailoring Shop', amount: '1500', amountPaid: '980', balanceDue: '520', issueDate: new Date('2024-05-01'), dueDate: new Date('2024-05-31'), period: 'May 2024', status: 'overdue', items: [{ description: 'Monthly Fashion Levy', quantity: 1, unitPrice: 1500, amount: 1500 }] },
    { id: 'inv-6', invoiceNumber: 'INV-2024-0006', businessId: '6', businessName: 'Nana\'s Car Wash', amount: '1200', amountPaid: '1200', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Service Levy', quantity: 1, unitPrice: 1200, amount: 1200 }] },
    { id: 'inv-7', invoiceNumber: 'INV-2024-0007', businessId: '7', businessName: 'Golden Bookshop & Stationery', amount: '800', amountPaid: '800', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Others Levy', quantity: 1, unitPrice: 800, amount: 800 }] },
    { id: 'inv-8', invoiceNumber: 'INV-2024-0008', businessId: '8', businessName: 'Mama\'s Palace Mini-Mart', amount: '900', amountPaid: '600', balanceDue: '300', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'partial', items: [{ description: 'Monthly Trading Levy', quantity: 1, unitPrice: 900, amount: 900 }] },
    { id: 'inv-9', invoiceNumber: 'INV-2024-0009', businessId: '9', businessName: 'Golden Hands Hair Salon', amount: '1000', amountPaid: '1000', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Service Levy', quantity: 1, unitPrice: 1000, amount: 1000 }] },
    { id: 'inv-10', invoiceNumber: 'INV-2024-0010', businessId: '10', businessName: 'Prosperity Phone Hub', amount: '2000', amountPaid: '1650', balanceDue: '350', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-15'), period: 'June 2024', status: 'overdue', items: [{ description: 'Monthly Electronics Levy', quantity: 1, unitPrice: 2000, amount: 2000 }] },
    { id: 'inv-11', invoiceNumber: 'INV-2024-0011', businessId: '11', businessName: 'Fresh Day Restaurant', amount: '1600', amountPaid: '1600', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Food & Beverage Levy', quantity: 1, unitPrice: 1600, amount: 1600 }] },
    { id: 'inv-12', invoiceNumber: 'INV-2024-0012', businessId: '12', businessName: 'Sunshine Supermarket', amount: '2200', amountPaid: '2200', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Trading Levy', quantity: 1, unitPrice: 2200, amount: 2200 }] },
    { id: 'inv-13', invoiceNumber: 'INV-2024-0013', businessId: '13', businessName: 'Excel Point Technology', amount: '1800', amountPaid: '1400', balanceDue: '400', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'partial', items: [{ description: 'Monthly Electronics Levy', quantity: 1, unitPrice: 1800, amount: 1800 }] },
    { id: 'inv-14', invoiceNumber: 'INV-2024-0014', businessId: '14', businessName: 'Grace Beauty World', amount: '900', amountPaid: '900', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Fashion Levy', quantity: 1, unitPrice: 900, amount: 900 }] },
    { id: 'inv-15', invoiceNumber: 'INV-2024-0015', businessId: '15', businessName: 'Afia Luxury Salon', amount: '1000', amountPaid: '1000', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Service Levy', quantity: 1, unitPrice: 1000, amount: 1000 }] },
    { id: 'inv-16', invoiceNumber: 'INV-2024-0016', businessId: '16', businessName: 'Wofa Men\'s Store', amount: '1200', amountPaid: '800', balanceDue: '400', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-15'), period: 'June 2024', status: 'overdue', items: [{ description: 'Monthly Trading Levy', quantity: 1, unitPrice: 1200, amount: 1200 }] },
    { id: 'inv-17', invoiceNumber: 'INV-2024-0017', businessId: '17', businessName: 'Emefa Food Stall', amount: '800', amountPaid: '800', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Food & Beverage Levy', quantity: 1, unitPrice: 800, amount: 800 }] },
    { id: 'inv-18', invoiceNumber: 'INV-2024-0018', businessId: '18', businessName: 'True Grace Stationery', amount: '600', amountPaid: '600', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Others Levy', quantity: 1, unitPrice: 600, amount: 600 }] },
    { id: 'inv-19', invoiceNumber: 'INV-2024-0019', businessId: '19', businessName: 'God\'s Help Logistics', amount: '1400', amountPaid: '1400', balanceDue: '0', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'paid', items: [{ description: 'Monthly Service Levy', quantity: 1, unitPrice: 1400, amount: 1400 }] },
    { id: 'inv-20', invoiceNumber: 'INV-2024-0020', businessId: '20', businessName: 'New Pearl Mini Market', amount: '700', amountPaid: '550', balanceDue: '150', issueDate: new Date('2024-06-01'), dueDate: new Date('2024-06-30'), period: 'June 2024', status: 'partial', items: [{ description: 'Monthly Trading Levy', quantity: 1, unitPrice: 700, amount: 700 }] },
  ];
  ...
  const dueData: (typeof s.dueCollections.$inferInsert)[] = [
    ...
    { id: 'due-5', businessId: '8', businessName: 'Mama\'s Palace Mini-Mart', amountDue: '250', dueDate: new Date('2024-06-30'), daysOverdue: 0, status: 'due', zone: 'Zone A - Central', ownerName: 'Gifty Mensah', ownerPhone: '+233 20 444 5566' },
    { id: 'due-6', businessId: '10', businessName: 'Prosperity Phone Hub', amountDue: '350', dueDate: new Date('2024-06-15'), daysOverdue: 1, status: 'overdue', zone: 'Zone B - Adum', ownerName: 'Samuel Osei', ownerPhone: '+233 27 666 8899' },
    { id: 'due-7', businessId: '13', businessName: 'Excel Point Technology', amountDue: '200', dueDate: new Date('2024-06-30'), daysOverdue: 0, status: 'due', zone: 'Zone C - Bantama', ownerName: 'Richard Ansah', ownerPhone: '+233 20 999 4455' },
    { id: 'due-8', businessId: '16', businessName: 'Wofa Men\'s Store', amountDue: '300', dueDate: new Date('2024-06-15'), daysOverdue: 1, status: 'overdue', zone: 'Zone D - Suame', ownerName: 'Kwadwo Mensah', ownerPhone: '+233 20 333 9900' },
    { id: 'due-9', businessId: '20', businessName: 'New Pearl Mini Market', amountDue: '180', dueDate: new Date('2024-06-30'), daysOverdue: 0, status: 'due', zone: 'Zone E - Tafo', ownerName: 'Esther Boateng', ownerPhone: '+233 55 888 2211' },
  ];
  ...
  const levyData: (typeof s.levyBills.$inferInsert)[] = [
    ...
    { businessId: '7', businessName: 'Golden Bookshop & Stationery', amount: '800', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '8', businessName: 'Mama\'s Palace Mini-Mart', amount: '900', dueDate: new Date('2024-06-30'), status: 'partial', period: 'June 2024' },
    { businessId: '9', businessName: 'Golden Hands Hair Salon', amount: '1000', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '10', businessName: 'Prosperity Phone Hub', amount: '2000', dueDate: new Date('2024-06-15'), status: 'overdue', period: 'June 2024' },
    { businessId: '11', businessName: 'Fresh Day Restaurant', amount: '1600', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '12', businessName: 'Sunshine Supermarket', amount: '2200', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '13', businessName: 'Excel Point Technology', amount: '1800', dueDate: new Date('2024-06-30'), status: 'partial', period: 'June 2024' },
    { businessId: '14', businessName: 'Grace Beauty World', amount: '900', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '15', businessName: 'Afia Luxury Salon', amount: '1000', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '16', businessName: 'Wofa Men\'s Store', amount: '1200', dueDate: new Date('2024-06-15'), status: 'overdue', period: 'June 2024' },
    { businessId: '17', businessName: 'Emefa Food Stall', amount: '800', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '18', businessName: 'True Grace Stationery', amount: '600', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '19', businessName: 'God\'s Help Logistics', amount: '1400', dueDate: new Date('2024-06-30'), status: 'paid', period: 'June 2024' },
    { businessId: '20', businessName: 'New Pearl Mini Market', amount: '700', dueDate: new Date('2024-06-30'), status: 'partial', period: 'June 2024' },
  ];
